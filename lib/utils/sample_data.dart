...
class DowntimeData {
  static List<DowntimeD> data = [
    DowntimeD(
      id: 0,
      apiName: 'Fractus API',
      outage: DateTime.parse('2022-09-11 20:18:04Z'),
      inteval: 30,
      downtime: 1.1,
      p: 'P1',
    ),
    DowntimeD(
        id: 1,
        apiName: 'Aurum Admin Prod01',
        outage: DateTime.parse('2022-09-11 16:11:04Z'),
        inteval: 30,
        downtime: 1.6,
        p: 'P2'),
    DowntimeD(
        id: 2,
        apiName: 'Viprs Indicum',
        outage: DateTime.parse('2022-07-11 10:28:04Z'),
        inteval: 30,
        downtime: 1.9,
        p: 'P1'),
    DowntimeD(
...
class IndividualAPIData {
  static List<APIData> data = [
    ...
    APIData(
        id: 8, apiName: "Aurum Admin Prod01", uptime: "100%", status: "DOWN"),
  ];
}
